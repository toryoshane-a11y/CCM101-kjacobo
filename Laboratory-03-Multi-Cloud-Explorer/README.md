...
Mem:           1.9Gi       428Mi       828Mi       1.1Mi       814Mi       1.4Gi
Swap:          1.0Gi          0B       1.0Gi
...
If this Linux server were migrated to the cloud, it could be hosted using virtual machine services from the major cloud providers. In AWS, the server could run on Amazon EC2, while in Microsoft Azure, it could use Azure Virtual Machines. For Google Cloud (GCP), the equivalent service is Google Compute Engine. All three services allow users to run Linux servers in the cloud, with options to choose the amount of CPU, memory, storage, and other resources needed.

## Screenshots
![OS Release](screenshots/osrelease.png)
![CPU Info](screenshots/cpuinfo.png)
![Memory](screenshots/memory.png)
![Disk Space](screenshots/diskspace-lab3.png)
